...
const GeminiConfigSchema = import_model.GenerationCommonConfigSchema.extend({
    ...
    responseModalities: import_genkit.z.array(import_genkit.z.enum([
        ...
        "IMAGE",
        "AUDIO"
    ])).describe("The modalities to be used in response.").optional(),
...
const KNOWN_GEMINI_MODELS = {
    "gemini-3.1-pro-preview-customtools": commonRef("gemini-3.1-pro-preview-customtools"),
...
const VeoConfigSchema = import_genkit.z.object({
    ...
    durationSeconds: import_genkit.z.number().step(1).min(4).max(8).describe("Length of each output video in seconds.").optional(),
    resolution: import_genkit.z.enum([
        "720p",
        "1080p",
        "4k"
    ]).describe("Resolution of the output video.").optional(),
    seed: import_genkit.z.number().int().describe("Random seed for the video generation.").optional(),
...
const KNOWN_MODELS = {
    ...
    "imagen-4.0-generate-001": commonRef("imagen-4.0-generate-001"),
    "imagen-4.0-ultra-generate-001": commonRef("imagen-4.0-ultra-generate-001"),
    "virtual-try-on-001": commonRef("virtual-try-on-001", {
        supports: {
            media: true,
            multiturn: false,
            tools: false,
