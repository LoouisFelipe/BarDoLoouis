...
/**
 * @fileOverview Componente Combobox com suporte a criação dinâmica.
 * CTO: shouldFilter={false} para permitir que o motor manual controle a exibição do botão "Nova".
 * Saneamento: Aspas escapadas (&quot;) para conformidade total com o build de produção do Next.js.
 */
